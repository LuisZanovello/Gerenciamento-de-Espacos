            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="indexCartao.jsp">Área do Cartão</a> <!-- primeiro link direita superior-->
                        </li>
        ...
        <tr>
                            ...
                            <div class="col-lg-2">
                                <table class="table table-striped">
                                    ...
                                    <td><a href="ManterCartaoController?acao=prepararOperacao&operacao=Editar&id=<c:out value="${cartao.id}"/>" 
                                           class="btn btn-outline-success" role="button" aria-pressed="true">Editar</a></td>

                                    <td><a href="ManterCartaoController?acao=prepararOperacao&operacao=Excluir&id=<c:out value="${cartao.id}"/>"
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="indexCartao.jsp"><button class="btn btn-outline-dark btn-sm" value="Voltar">Voltar</button></a>
                                                </td>
                                            </tr>
