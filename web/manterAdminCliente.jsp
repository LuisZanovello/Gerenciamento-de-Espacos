...
<html>
    ...
    <form action="ManterAdminClienteController?acao=confirmarOperacao&operacao=${operacao}" method="post" name="frmManterCliente">
...
<a href="PesquisaAdminClienteController"><button value="Voltar">Voltar</button></a>
    </body>
</html>
