            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.jsp">Área do Tipo de Espaço</a> <!-- primeiro link direita superior-->
                        </li>
                       ...
                       <c:forEach items="${tiposEspacos}" var="tipoEspaco">
                            ...
                            <div class="col-lg-2">
                                <table class="table table-striped">
                                    ...
                                    <td><a href="ManterTipoEspacoController?acao=prepararOperacao&operacao=Editar&id=<c:out value="${tipoEspaco.id}"/>" 
                                           class="btn btn-outline-success" role="button" aria-pressed="true">Editar</a></td>

                                    <td><a href="ManterTipoEspacoController?acao=prepararOperacao&operacao=Excluir&id=<c:out value="${tipoEspaco.id}"/>"
