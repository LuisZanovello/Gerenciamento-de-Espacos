                ...
                <div class="col-lg-12">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>    <input type="text" onkeyup="validare(this,'numero')"required="required" min="1" max="9999999999" autocomplete="off" placeholder="Digite apenas numeros" maxlength="10"  class="form-control" name="txtCodReembolso" value="${reembolso.id}" autofocus<c:if test="${operacao != 'Incluir'}"> readonly</c:if>></td>
                            </tr>
