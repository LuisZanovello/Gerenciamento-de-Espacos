                    ...
                    <c:forEach items="${modalidades}" var="modalidade">
                        ...
                        <div class="col-lg-2">
                            <table class="table table-striped">
                                ...
                                <td><a href="ManterAdminModalidadeController?acao=prepararOperacao&operacao=Editar&id=<c:out value="${modalidade.id}"/>"
                                       class="btn btn-outline-success" role="button" aria-pressed="true">Editar</a></td>
                                <td><a href="ManterAdminModalidadeController?acao=prepararOperacao&operacao=Excluir&id=<c:out value="${modalidade.id}"/>"
