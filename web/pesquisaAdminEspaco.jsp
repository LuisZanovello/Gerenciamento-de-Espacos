...
<table border="1">
    ...
    <c:forEach items="${espacos}" var="espaco">
        <tr>
            ...
            <td><a href="ManterAdminEspacoController?acao=prepararOperacao&operacao=Editar&id= <c:out value="${espaco.id}"/>">Editar</a></td>
            <td><a href="ManterAdminEspacoController?acao=prepararOperacao&operacao=Excluir&id= <c:out value="${espaco.id}"/>">Excluir</a></td>
        </tr>
    </c:forEach>
</table>
