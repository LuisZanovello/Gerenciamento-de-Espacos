...
<html>
    <head>
        ...
        <title>Admin Espaços - ${operacao}</title>
    </head>
    <body>
       <h2>Manter Espaco - ${operacao}</h2>
         <form action="ManterAdminEspacoController?acao=confirmarOperacao&operacao=${operacao}" method="post">
<table>
    <tr>
    <td>Codigo Espaco</td>
    ...
    <input type="submit" name="btnConfirmar" value="Confirmar">
      ...
      <a href="PesquisaAdminEspacoController"><button value="Voltar">Voltar</button></a>
    </body>
</html>
