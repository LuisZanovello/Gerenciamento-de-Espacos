 ...
 * @author viict
 */
public class ReportPagamentoController extends HttpServlet {
 ...
 /*  parametros.put("PAR_codCurso", Integer.parseInt(request.getParameter("txtCodCurso")));*/
            ...
            String relatorio = getServletContext().getRealPath("/WEB-INF/classes/relatorio") + "/ReportPagamento.jasper";
